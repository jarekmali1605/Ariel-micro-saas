...
# Definicja początkowego powitania (Używa genai.types.Content i genai.types.Part)
INITIAL_HISTORY_CONTENT = genai.types.Content(
    role="model", 
    ...
    if history_path.exists():
        try:
            with open(history_path, "r", encoding="utf-8") as f:
                ...
                # Używamy genai.types.Content.from_dict do deserializacji
...
# -------------------------------------------------------
# INICJALIZACJA MODELU Z PEŁNĄ INSTRUKCJĄ SYSTEMOWĄ (PROMPT)
# -------------------------------------------------------
